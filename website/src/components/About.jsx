const SKILLS = {
  ...
  "Tools & Technologies": ["Docker", "Azure", "Airflow", "Tableau", "Excel"],
};
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <p className="text-slate-300 text-lg leading-relaxed mb-5">
              Hi! I&apos;m{" "}
              <span className="text-indigo-400 font-semibold">Smarth Kaul</span>
              , a Statistics student at the{" "}
              <span className="text-indigo-400">University of Toronto</span>{" "}
              specializing in Statistical Machine Learning and Data Mining.
            </p>
            <p className="text-slate-400 leading-relaxed mb-5">
              I&apos;m passionate about using data to uncover insights and build
              models that solve real problems. My experience spans machine
              learning research, data analysis in enterprise environments, and
              business consulting — giving me a perspective that bridges
              technical depth with practical impact.
            </p>
            <p className="text-slate-400 leading-relaxed mb-5">
              I&apos;ve worked at Grant Thornton, the Independent Electricity
              System Operator (IESO), and TekUncorked — building everything from
              SQL-driven QA pipelines to supervised learning models for energy
              disaggregation.
            </p>
            {/* TODO: Add a personal touch — hobbies, interests, what you do outside work */}
            <p className="text-slate-400 leading-relaxed mb-10">
              Outside of academics and work, I enjoy tennis, learning the
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-5 mb-8">
              ...
              <p className="text-slate-300 text-sm">
                BS, Statistics — Statistical Machine Learning &amp; Data Mining
                Specialist
              </p>
              <p className="text-slate-500 text-xs font-mono mt-1">
                Sept 2021 – 2026 · Toronto, ON
              </p>
            </div>
